...
const stats = ref([
  ...
  { key: 'todayCommissions', label: '今日佣金', value: '¥12,580', icon: 'TrendCharts', iconBg: '#fff0f6' },
  { key: 'weekCommissions', label: '周佣金发放', value: '¥85,690', icon: 'Calendar', iconBg: '#f6ffed' },
  { key: 'monthCommissions', label: '月佣金发放', value: '¥1,258,000', icon: 'TrendCharts', iconBg: '#fff7e6' }
])
